...
describe("milestone status model", () => {
  ...
  it("ties the current Platform milestone to the active Phase 4 goal after Phase 3 clearance", () => {
    ...
    expect(platform?.latestNote).toContain("Phase 4 provider integration now includes metadata-only recorded provider-review artifact load and verify commands");
