...
describe("milestone status model", () => {
  ...
  it("ties the current Platform milestone to the active Phase 4 goal after Phase 3 clearance", () => {
    ...
    expect(platform?.latestNote).toContain("Phase 4 provider integration now includes tested metadata-only recorded provider-review artifact load/verify commands with offline fingerprint verification and attached approval, audit, rollback, and permission evidence");
