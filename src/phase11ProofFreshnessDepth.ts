...
function handoffProofItem(
  ...
  return {
    ...
    nextAction:
      status === "ready"
        ? `Run ${OWNER_VISIBLE_PHASE3_PROOF_COMMAND} and keep the owner handoff record attached, matching current evidence, and backed by fresh matching CLI validation, proof-export evidence, and trusted Phase 3 goal/PM traceability before provider or release readiness advances.`
