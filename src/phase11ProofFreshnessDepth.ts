...
function handoffProofItem(
  ...
  return {
    ...
    nextAction:
      status === "ready"
        ? `Run ${OWNER_VISIBLE_PHASE3_PROOF_COMMAND} and keep the owner handoff record attached, matching current evidence, and backed by fresh matching CLI validation, proof-export evidence, and trusted current active goal/PM traceability before provider or release readiness advances.`
