...
describe("phase 3 owner-visible proof panel", () => {
  ...
  it("renders imported desktop proof, panel provenance, and fresh handoff details for owner review", () => {
    ...
    expect(html).toContain(
      'aria-label="Phase 1 2 6 publish hold traceability counts"><div><dt>Phases</dt><dd>3</dd></div><div title="goal=goal-phase-1-2-6-publish phases=3/3 pm=20/20 trustedPm=20/20 epics=3 parents=6 children=11 priority=0/3 hold=blocked"><dt>PM</dt><dd>20/20</dd></div><div title="goal=goal-phase-1-2-6-publish phases=3/3 pm=20/20 trustedPm=20/20 epics=3 parents=6 children=11 priority=0/3 hold=blocked"><dt>Proof</dt><dd>0/3</dd></div><div><dt>Hold</dt><dd>blocked</dd></div></dl>'
    );
    expect(html).toContain(
