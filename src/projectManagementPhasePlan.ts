    ...
    parents: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            description: "Persist stream, final status, exact missing-signal review detail, compact signal-count proof, method counts, and any fallback reason in owner-visible proof rows.",
            completionPercent: 60,
            complexity: "high",
    ...
    parents: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            description: "Confirm controls, stream state, final response, proof rows, panel completion/token/foreign-token counts, and runtime route-isolation quarantine counts cannot bleed into another panel.",
            completionPercent: 60,
            complexity: "high",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            description: "Link Phase 1 live proof, Phase 2 isolation proof, Phase 6 PM staging, required PM rows by Epic/Parent/Child kind, priority proof counts, compact local-hold evidence key, and the owner-held publish blocker before pushing is considered.",
            completionPercent: 60,
            complexity: "medium",
