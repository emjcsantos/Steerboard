    ...
    parents: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            description: "Show desktop proof clearance, exact blocker visibility, trusted current-goal and PM traceability precondition, visible handoff record-gate reason, local owner handoff record actions, export-ready current-evidence fingerprint, fresh CLI validation, clearance snapshot, age matching, and the provider-integration boundary before Phase 4 advances.",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            description: "Link Owner Testing command gates, proof freshness depth, current active Phase 3 clearance PM traceability and handoff proof, evidence records, release readiness, visible Security 100% final closure guidance, required PM rows, and packaging holds before release review can be trusted.",
