  ...
  },
  {
    ...
    parents: [
      ...
      },
      {
        ...
        description: "Keep clean checkout, build/test, smoke proof, current active Phase 3 goal/PM traceability, packaging lock, docs, known limits, evidence records, and release decision visible while packaging stays paused.",
        completionPercent: 40,
        complexity: "high",
        ...
        children: [
          {
            ...
            description: "Validate packaged-app prerequisites, proof persistence, current active Phase 3 goal/PM traceability, evidence-record inputs, local storage repair, safety-disabled live actions, and release holds without executing packaging.",
            completionPercent: 40,
            complexity: "high",
          ...
          },
          {
            ...
            description: "Link Owner Testing command gates, proof freshness depth, current active Phase 3 goal/PM traceability, evidence records, release readiness, required PM rows, and packaging holds before release review can be trusted.",
            completionPercent: 35,
            complexity: "high",
