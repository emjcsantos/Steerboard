        ...
        children: [
          {
            ...
            description: "Show worker objective, files owned, validation plan, retry limit, role coverage counts, per-role handoff packet integrity, handoff expectation, validation gate depth, dispatchReviewDepthProof, offline artifact verification, launch-gate canSpawn=no proof, closure-gate canClose metadata proof, closeoutProof state, ownerHandoffProof, PM coverage, and local no-runtime boundary before launch.",
            completionPercent: 94,
          ...
          },
          {
            ...
            description: "Keep final integration, validation, commit, push approval, reporting, dispatch-review traceability, five-link traceability coverage, closure boundary, artifact verification, launch-gate approval-required proof, closure-gate no-spawn proof, aggregate closeout proof, owner handoff report proof, and integrationOwnershipProof owned by the main Arena path.",
            completionPercent: 94,
        ...
        children: [
          {
            ...
            title: "Handoff Trace",
            description: "Show what each worker is expected to own, validate, retry, depend on, and hand back with handoff task counts, four per-role packet ownership, dependency order, validation labels, dispatchReviewDepthProof, offline artifact verification, launch-gate proof, closure-gate proof, closeoutProof state, ownerHandoffProof, and local no-runtime boundaries without polluting the main context.",
            completionPercent: 94,
            complexity: "high",
          ...
          },
          {
            ...
            description: "Audit visible role counts, max attempt limits, handoff task depth, per-role handoff packet integrity, current evidence fingerprint freshness, validation gate depth, dispatchReviewDepthProof, offline dispatch-review artifact verification, live-worker launch-gate proof, closure-gate proof, closeoutProof state, ownerHandoffProof, and the no-live-worker execution lock for staged PM Run outputs.",
            completionPercent: 94,
            complexity: "high",
          ...
          },
          {
            ...
            description: "Link Phase 7 remaining-goal status, PM child rows, dispatch review depth, evidence freshness, offline artifact verification, integration ownership depth, launch-gate canSpawn=no proof, closure-gate canClose metadata proof, aggregate closeout proof, owner handoff report proof, PM coverage, five-link traceability, closure boundary, live-worker locks, and dispatchTraceabilityProof before any worker spawning can be trusted.",
            completionPercent: 94,
            complexity: "high",
