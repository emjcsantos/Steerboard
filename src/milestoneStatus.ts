...
export const steerboardMilestoneStatuses: MilestoneStatus[] = [
  ...
  },
  {
    ...
    completionPercent: 60,
    latestNote:
      "Multi-panel cockpit, adaptive magnetic layout with project drag-in, session drag-in, drop previews, keyboard adjustment, and local chat-lane scaffold exist; visible panels can use panel-keyed live session chat and per-panel session controls, with native two-panel smoke still pending.",
    nextStep:
      "Run native two-panel smoke and live-control smoke, then continue command capability work.",
    tone: "active",
    note:
      "Fixed layouts, adaptive panel geometry, project drag-in, session drag-in, drop previews, local monitor previews, and chat-lane scaffolding exist, but live provider-backed behavior is not complete."
  },
  {
