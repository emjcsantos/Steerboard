...
describe("remaining goal plan", () => {
  ...
  it("keeps the Phase 8 permission audit target linked to traceability and audit persistence", () => {
    ...
    expect(phase8Epic?.completionPercent).toBe(96);
