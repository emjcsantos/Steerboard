...
export const remainingGoalPlan: RemainingGoalPlanItem[] = [
  ...
  },
  {
    ...
    nextAction:
      "Use the Phase 4 Provider Readiness catalog depth, Refresh Safety depth, Surface Depth, local approval, audit, rollback, and permission record validation, recorded provider-review artifact loading and verification with attached local record evidence, traceability, blocker-priority panels, and owner-visible provider readiness check to keep source coverage, setup blockers, capability gaps, preview rows, approval, audit, rollback, permission, fresh fingerprint-matched metadata-only refresh proof, PM links, and execution locks ready before provider execution is considered."
  },
  {
