...
export const remainingGoalPlan: RemainingGoalPlanItem[] = [
  ...
  },
  {
    ...
    nextAction:
      "Keep the Phase 4 provider completion status proof attached with catalog-depth, refresh-safety, surface-depth, traceability, blocker-priority, PM-link, and provider execution-lock evidence visible. Provider execution remains locked while Phase 5 migration review stays separate."
  },
  {
