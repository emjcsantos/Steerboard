...
export const remainingGoalPlan: RemainingGoalPlanItem[] = [
  ...
  },
  {
    ...
    nextAction:
      "Use the Phase 4 Provider Readiness catalog depth, Refresh Safety depth, Surface Depth, traceability, and blocker-priority panels to resolve source coverage, setup blockers, capability gaps, preview rows, fresh fingerprint-matched metadata-only refresh proof, PM links, and execution locks before provider execution is considered."
  },
  {
  ...
  },
  {
    ...
    phaseIds: ["phase-11-owner-packaging"],
    goal:
      "Coordinate the final clean-checkout, build, smoke, current active Phase 3 clearance PM traceability and handoff proof, packaging-lock, docs, known-limits, owner release traceability, blocker-priority review, structured evidence records, and release-decision pass before release.",
    status: "next",
    priority: "high",
    ...
    nextAction:
      "Use the Phase 11 Release Readiness, Evidence Records, owner release traceability, and blocker-priority panels to require structured clean-checkout, build/test, current active Phase 3 clearance PM traceability with handoff proof, and docs-known-limits evidence before any ready state can recommend release while packaging stays paused."
  }
];
