...
export const remainingGoalPlan: RemainingGoalPlanItem[] = [
  ...
  },
  {
    ...
    nextAction:
      "Use the Phase 3 handoff gate to record or clear the local owner handoff only after desktop proof clearance is exit-ready, then keep Phase 4 held behind the provider boundary."
  },
  {
    ...
    nextAction:
      "Use the Phase 4 Provider Readiness panel to resolve setup-required, unsupported, unavailable, blocked, preview, and ready labels before enabling execution."
  },
  {
  ...
  },
  {
    ...
    nextAction:
      "Use the Phase 8 Audit Depth panel to resolve missing permission, approval, evidence, audit persistence, and rollback explanations before mutation paths grow."
  },
  {
