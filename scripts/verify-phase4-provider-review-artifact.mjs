...
const requiredCommandSkillProofTerms = [
  ...
  "commandItemOrder=present",
  "skillItemOrder=present",
  "commandMetadata=present",
  "skillMetadata=present",
  "commandSource=present",
  "skillSource=present",
...
const requiredPluginMcpProofTerms = [
  ...
  "pluginItemOrder=present",
  "mcpItemOrder=present",
  "pluginMetadata=present",
  "mcpMetadata=present",
  "pluginSource=present",
  "mcpSource=present",
