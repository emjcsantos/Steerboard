...
The first scaffold uses a minimal Tauri shell that loads the Vite Arena UI during development and keeps privileged desktop capabilities behind future adapter boundaries.
