...
- Cockpit monitor controls reuse local stream gates so starting, pausing, and resetting the preview remains side-effect-free and permissioned by local adapter readiness.
