...
| Permission And Audit Layer | 55% | Provider-neutral approval gates, approval-first read-only terminal probe runner, redacted local audit records, and a Phase 8 Audit Depth panel now explain missing permission, approval, evidence, audit persistence, and rollback requirements; Git/MCP/plugin/automation/runtime/profile/external mutation remains deferred. |
