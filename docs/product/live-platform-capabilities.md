...
| Release Readiness | 20% | The Phase 11 Release Readiness gate now tracks clean checkout, build/test, smoke proof, current Phase 3 goal/PM traceability, packaging lock, docs/known limits, and release decision while packaging remains paused. |
