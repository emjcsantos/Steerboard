...
| Release Readiness | 20% | The Phase 11 Release Readiness gate now tracks clean checkout, build/test, smoke proof, Phase 3 clearance PM traceability with handoff proof, packaging lock, docs/known limits, and release decision while packaging remains paused. |
