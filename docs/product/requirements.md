...
- The environment panel should expose Phase 11 release readiness so users can see clean checkout, build/test, owner smoke proof, packaging lock, docs/known limits, and final release decision while packaging remains paused.
