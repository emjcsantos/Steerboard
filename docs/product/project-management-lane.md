...
- Phase 11 Release Readiness gate for clean checkout, build/test, smoke proof, current Phase 3 clearance PM traceability with handoff proof, packaging lock, docs/known limits, owner release traceability, blocker-priority review, and release decision while packaging stays paused.
- Item detail panel.
