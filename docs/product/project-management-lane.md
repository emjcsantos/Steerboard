...
- Phase 3 clearance package, blocker-priority queue, command plan, and handoff gate with exact open blockers, command-addressable blocker status, next smoke action, local owner handoff record/clear actions, and provider-integration boundary.
