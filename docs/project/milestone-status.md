...
| Platform capabilities | In progress | Panel slash commands now expose structured ready, preview, blocked, unsupported, and unavailable feedback while mutation-class platform actions remain non-executable. |
...
| Platform capabilities | Make commands, plugins, automations, MCP, personalization, permissions, and audit state live. | In progress | 34% | Panel slash commands now expose structured ready, preview, blocked, unsupported, and unavailable feedback while mutation-class platform actions remain non-executable. | Connect refreshable provider catalogs to the command surface while keeping arbitrary terminal commands, Git mutation, MCP/plugin/automation execution, runtime/profile mutation, and external-service actions disabled. |
