...
| Cockpit monitor and operating modes | In progress | Multi-panel cockpit, adaptive magnetic layout with project drag-in and keyboard adjustment, and local chat-lane scaffold exist; visible panels can use panel-keyed live session chat and per-panel session controls, with native two-panel smoke still pending. |
...
| Cockpit monitor and operating modes | Complete core cockpit panels, control affordances, and visible operating-mode cues. | In progress | 58% | Multi-panel cockpit, adaptive magnetic layout with project drag-in and keyboard adjustment, and local chat-lane scaffold exist; visible panels can use panel-keyed live session chat and per-panel session controls, with native two-panel smoke still pending. | Run native two-panel smoke and live-control smoke, then continue command capability work. |
