...
| Security and privacy model | Set baseline protections, data-handling boundaries, and reviewable controls. | In progress | 70% | Real-project-data and runtime-adapter edge gates are now represented in release privacy readiness. | Complete security acceptance checks from live cockpit runs before packaging resumes. |
