...
| Platform capabilities | In progress | Panel slash commands now use a refreshable provider-neutral catalog snapshot with ready, preview, blocked, unsupported, and unavailable feedback while mutation-class platform actions remain non-executable. |
...
| Platform capabilities | Make commands, plugins, automations, MCP, personalization, permissions, and audit state live. | In progress | 34% | Panel slash commands now use a refreshable provider-neutral catalog snapshot with ready, preview, blocked, unsupported, and unavailable feedback while mutation-class platform actions remain non-executable. | Connect real provider catalog refresh calls beyond the safe seeded snapshot while keeping arbitrary terminal commands, Git mutation, MCP/plugin/automation execution, runtime/profile mutation, and external-service actions disabled. |
