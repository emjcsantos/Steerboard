...
| Cockpit monitor and operating modes | In progress | Real-time cockpit monitoring is active; operating modes are being refined for easier operator workflows. |
...
| Optional project management lane | Paused | Kept optional by design and deferred from current development focus while core cockpit milestones are completed. |
