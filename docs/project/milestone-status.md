...
Overall completion: 41%. Next milestone: Owner testing hardening. Next step: Run the full local testing checklist, verify approval-to-probe behavior, provider command refresh behavior, and disabled-path evidence (terminal, Git, MCP, plugin, automation, runtime, profile, and external), and keep desktop-backed mutation as a future phase.
...
| Platform capabilities | In progress | Panel slash commands now refresh through a desktop-backed safe provider capability bridge with ready, preview, blocked, unsupported, and unavailable feedback while mutation-class platform actions remain non-executable. |
...
| Platform capabilities | Make commands, plugins, automations, MCP, personalization, permissions, and audit state live. | In progress | 38% | Panel slash commands now refresh through a desktop-backed safe provider capability bridge with ready, preview, blocked, unsupported, and unavailable feedback while mutation-class platform actions remain non-executable. | Extend the same safe provider refresh pattern to plugins, skills, MCP, automations, and personalization while keeping arbitrary terminal commands, Git mutation, MCP/plugin/automation execution, runtime/profile mutation, and external-service actions disabled. |
