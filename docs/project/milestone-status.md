...
| Cockpit monitor and operating modes | In progress | Compact live health, compact file-scope visibility, compact panel identity visibility, panel roster, hidden-panel queue, attention, stream quality, layout-capacity, and loop validation signals are being added for easier monitoring. |
