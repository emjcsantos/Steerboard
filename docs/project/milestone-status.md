...
| Cockpit monitor and operating modes | In progress | Compact live health, attention, stream quality, and loop validation signals are being added for easier monitoring. |
