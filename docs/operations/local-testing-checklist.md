...
6. `Slash Commands`
   ...
   - Confirm legacy, stale, future-dated, wrong-panel, or fingerprint-mismatched slash/session storage proof returns to review and asks for current panel transcript/session refresh before Phase 3 can exit.
