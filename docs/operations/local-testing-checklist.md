...
6. `Slash Commands`
   ...
   - Confirm the Owner Testing action bridge imports desktop proof rows, records only fresh fingerprint-matched handoff evidence, rejects held handoff states, and clears the handoff record without clearing smoke proof storage.
