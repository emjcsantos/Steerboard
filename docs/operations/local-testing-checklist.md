...
2. `Connect`
   ...
   - Confirm the Phase 11 Release Readiness panel shows clean checkout, build/test, owner smoke proof, packaging lock, docs/known limits, current Phase 3 clearance PM traceability with handoff proof, and final release decision as separate gates.
   - Confirm the release readiness decision remains held while clean checkout, build/test, smoke proof, current Phase 3 clearance PM traceability with handoff proof, docs/known limits, owner proof, or remaining-goal blockers are unresolved.
