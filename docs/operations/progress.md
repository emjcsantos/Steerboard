...
| Documentation cleanup | Complete | `codex/cleanup-steerboard-docs-plan` / pending | `git diff --check` PASS; stale-name scan PASS; private-reference scan PASS; core-doc runtime wording scan PASS; BOM scan PASS | Start Phase 1 Steerboard scaffold |
