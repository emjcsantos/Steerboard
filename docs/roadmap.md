...
| Phase 7: Platform Capabilities | In progress | Slash commands, Skills catalog, Plugin manager, MCP manager, and Automations manager now expose structured feedback plus desktop-backed safe provider capability refresh; personalization, permissions, and audit state continue toward live provider-backed surfaces. |
