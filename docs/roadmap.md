...
| Phase 7: Platform Capabilities | In progress | Slash commands now expose structured command feedback plus desktop-backed safe provider capability refresh; plugins, automations, MCP, personalization, permissions, and audit state continue toward live provider-backed surfaces. |
