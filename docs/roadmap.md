...
| Phase 3: Project Management Lane | In progress | Pipeline items can be inspected, request history is local, and dispatch-ready items can create local cockpit run projections. |
