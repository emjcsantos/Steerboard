...
| Phase 7: Platform Capabilities | In progress | Slash commands, Skills catalog, Plugin manager, and MCP manager now expose structured feedback plus desktop-backed safe provider capability refresh; automations, personalization, permissions, and audit state continue toward live provider-backed surfaces. |
