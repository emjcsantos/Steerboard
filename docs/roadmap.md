...
| Phase 7: Platform Capabilities | Planned | Slash commands now expose structured command feedback; plugins, automations, MCP, personalization, permissions, and audit state become live provider-backed surfaces. |
