...
- Fail-closed Phase 3 proof export that prepares downloadable owner-review JSON only after offline verification is ready, while imported proof packages return to review unless they match the current focused panel and owner-visible handoff fingerprint.
