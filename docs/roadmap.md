...
- Release readiness gate for fresh checkout, clean checkout, build/test, owner smoke proof with Phase 3 proof-export detail, current active Phase 3 clearance PM traceability with handoff proof and proof-export evidence, current non-ready proof freshness row actions for handoff/proof-export review, docs/known limits, security closure capability, and final release decision.
